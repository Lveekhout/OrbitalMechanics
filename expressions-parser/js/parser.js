function Parser(str) {
    ...
    const isFunction = () => 'sin(' === str.slice(pos, pos + 4)
        || 'cos(' === str.slice(pos, pos + 4)
        || 'tan(' === str.slice(pos, pos + 4)
        || 'ln(' === str.slice(pos, pos + 3)
        || 'log(' === str.slice(pos, pos + 4)
        || 'sqrt(' === str.slice(pos, pos + 5)
